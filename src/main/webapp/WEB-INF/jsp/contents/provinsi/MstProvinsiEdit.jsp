...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Provinsi Edit</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    ...
    <div class="container-fluid">
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form:form method="post" id="quickForm" action="${pageContext.request.contextPath}/provinsi/edit/save" modelAttribute="MstProvinsiEdit">
              	...
              	<div class="row">
	               <div class="col-md-6">
		             <div class="form-group">
		                  ...
		                  <form:input readonly="true" class="form-control" placeholder="Kode Provinsi" path="kodeProvinsi" required=""/><form:errors path="kodeProvinsi"/>
		                </div>
		                <div class="form-group">
