...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Karyawan Add</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    ...
    <div class="container-fluid">
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form:form method="post" id="quickForm" action="${pageContext.request.contextPath}/karyawan/add/save" modelAttribute="MstKaryawanDto">
              	...
              	<div class="row">
	               <div class="col-md-6">
		             <div class="form-group">
		                  ...
		                  <form:input class="form-control" placeholder="Kode Karyawan" path="kodeKaryawan" required=""/><form:errors path="kodeKaryawan"/>
		                </div>
		                <div class="form-group">
