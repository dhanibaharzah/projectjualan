...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Kota Add</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    ...
    <div class="container-fluid">
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form:form method="post" id="quickForm" action="${pageContext.request.contextPath}/kota/add/save" modelAttribute="MstKotaAdd">
              	...
              	<div class="row">
	               <div class="col-md-6">
		             <div class="form-group">
		                  ...
		                  <form:input class="form-control" placeholder="Kode Kota" path="kodeKota" required=""/><form:errors path="kodeKota"/>
		                </div>
		                <div class="form-group">
		                ...
		                <div class="form-group">
		                  ...
		                  <form:select class="form-control" path="kodeProvinsi" id="kodeProvinsiDat">
		                  		<c:forEach items="${listprovinsi}" var="listprov">
									<form:option value="${listprov.kodeProvinsi}">${listprov.namaProvinsi}</form:option>
								</c:forEach>
		                  </form:select>
		                </div>
		             </div>
