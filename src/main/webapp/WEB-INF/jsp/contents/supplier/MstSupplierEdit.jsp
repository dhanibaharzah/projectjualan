  ...
  <section class="content">
    ...
    <div class="container-fluid">
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form:form method="post" id="quickForm" action="${pageContext.request.contextPath}/supplier/edit/save" modelAttribute="MstSupplierEdit">
              	...
              	<div class="row">
	               <div class="col-md-6">
		             	<div class="form-group">
		                  ...
		                  <form:input readonly="true" class="form-control" placeholder="Kode Supplier" path="kodeSupplier" required=""/><form:errors path="kodeSupplier"/>
		                </div>
		                <div class="form-group">
		                  ...
		                  <label>Nama Kota</label>
		                  	<form:select class="form-control" path="kodeKota" id="kodeKotaDat">
								<c:forEach items="${listkota}" var="listkota">
									<form:option value="${listkota.kodeKota}"><c:if test="${listkota.kodeKota == MstSupplierEdit.kodeKota}"></c:if>${listkota.namaKota}</form:option>
								</c:forEach>
							</form:select>
		                </div>
		             </div>
