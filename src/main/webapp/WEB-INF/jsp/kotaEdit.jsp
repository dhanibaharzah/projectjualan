		...
		<div class="container">
			<div class="well">
				<form:form class="form-horizontal"
					action="${pageContext.request.contextPath}/kota/saveKota"
					modelAttribute="editkota">
					<div class="form-group">
						<label class="control-label col-sm-2">Kode Kota:</label>
						<div class="col-sm-6">
							<form:input path="kodeKota" readonly="true" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2">Nama Kota:</label>
						<div class="col-sm-6">
							<form:input path="namaKota" />
						...
						<div class="col-sm-6">
							<form:select class="form-control" path="kodeProvinsi" id="kodeProvinsiDat">
								<c:forEach items="${listprovinsi}" var="listprov">
									<form:option value="${listprov.kodeProvinsi}"><c:if test="${listprov.kodeProvinsi == editkota.kodeProvinsi}"></c:if>${listprov.namaProvinsi}</form:option>
								</c:forEach>
							</form:select>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<a href="${pageContext.request.contextPath}/kota/listKota"
